function myFunction3() {
    ...
    document.getElementById("luoi2").style.display='block';
}   

function close2() {
    var z = document.getElementById("luoi2");
...
function populate(){
    if(quiz.isEnded()){
        ...
        //show question
        var element=document.getElementById('cauhoi2');
        ...
        for(var i=0; i<choices.length; i++){
            var element=document.getElementById("choice2"+i);
            element.innerHTML=choices[i];
            guess("bttn2"+i, choices[i]);
        }
    }
};
...
var questions = [
    new Question("Pài hát deo có đoạn “Một con đò sang ngang. Ôi lòng thầy mênh mang. Cho em biết yêu cánh cò trong câu ca dao…” là của tác giả nào?", ["Trần Tiến", "Hàn Ngọc Bích", "Lưu Hà An", "Trần Đức"], "Trần Đức"),
